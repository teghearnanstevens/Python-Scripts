...
def main():
    ...
    while True:
        ...
        if formula.islower() or not any(c.isdigit() for c in formula):
            print("Invalid input. Please enter a valid chemical formula in uppercase, e.g., 'C6H12O6'.")
        else:
            break
    ...
    while True:
        try:
            ...
            if sample_mass <= 0:
                print("Please enter a positive number for the mass.")
                continue
            break
        except ValueError:
            print("Invalid input. Please enter a numerical value for the mass.")
    ...
    try:
        ...
        print("Error: Invalid element in the formula.")
        return
