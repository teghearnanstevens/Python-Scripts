...
def main():
    ...
    with open(filename, "rt") as text_file:
        ...
        def load_nhtsa_data():
            while True:
                filename = input("Name of file that contains NHTSA data (or type 'quit' to exit): ")
        ...
        while True:
                user_input = input("Percent reduction of texting while driving [0, 100]: ")

                try:
                    
                    perc_reduc = float(user_input)
                    ...
                    print("Error: Please enter a valid numeric value between 0 and 100.")
        ...
        for row in reader:
            ...
            row = ["0" if cell.strip() == "" else cell for cell in row]
